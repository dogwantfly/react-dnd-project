...
function Header({ item }) {
  ...
  return (
      <header className="container z-10 sticky top-0 flex justify-between mb-[60px] pt-9 items-center">
        ...
        <div className={`lg:w-full lg:flex lg:justify-between lg:items-center fixed right-0 top-0 lg:max-w-none lg:static transition-all ease-in-out bg-[#333333] lg:bg-transparent overflow-hidden ${isMenuOpen ? 'max-w-full' : 'max-w-0'}`}data-menu>
